...
#SBATCH --job-name="qwen3-14b-sentence-sweep"
#SBATCH --nodes=1
...
#SBATCH --output=slurm_outputs/qwen3-14b-sentence-sweep-%A_%a.out
#SBATCH --export=ALL

# ===========================================================================
# Full retention/selector sweep for Qwen/Qwen3-14B, SENTENCE-LEVEL
...
#
# NOTE: no empirical per-task timing yet for this model/script combo.
# --mem bumped slightly vs the 4B version (96G vs 64G) since 14B needs more
# headroom to load; --time kept at the 24h partition default like Qwen3-4B
# (should fit, but reduce --time if it turns out too tight and you'd rather
# free up queue priority, or bump to boost_qos_lprod like gemma-26B-A4B if
# it doesn't fit in 24h).
# ===========================================================================
...
DATASETS=(
    "data/aime_2024/Qwen3-14B_teacher_traces.json"
    "data/aime2025/Qwen3-14B_teacher_traces.json"
    "data/aime_2026/Qwen3-14B_teacher_traces.json"
    "data/math-500/Qwen3-14B_teacher_traces.json"
    "data/zebralogic/Qwen3-14B_teacher_traces.json"
    "data/gpqa/Qwen3-14B_teacher_traces.json"
)
