...
#SBATCH --job-name="lowent-nonum-short-2gpu"
#SBATCH --nodes=1
...
#SBATCH --array=0-2
#SBATCH --output=slurm_outputs/lowent-nonum-short-2gpu-%A_%a.out
#SBATCH --export=ALL

# ===========================================================================
# Ablation low_entropy_no_numbers -- math-500 + gpqa, 2-GPU models.
# gemma-4-26B-A4B-it (both datasets), gpt-oss-120b (gpqa only, other
# datasets already done/in progress elsewhere).
# 3 tasks. 24h on boost_qos_lprod.
# ===========================================================================
