...
#SBATCH --job-name="lowent-nonum-short-1gpu"
#SBATCH --nodes=1
...
#SBATCH --array=0-7
#SBATCH --output=slurm_outputs/lowent-nonum-short-1gpu-%A_%a.out
#SBATCH --export=ALL

# ===========================================================================
# Ablation low_entropy_no_numbers -- math-500 + gpqa, 1-GPU models.
# gpt-oss-20b, gemma-4-E4B-it, Qwen3-14B, Qwen3-4B.
# 8 tasks. 24h on boost_qos_lprod.
# ===========================================================================
